...
const skillData = [
  {
    ...
    skills: [
      ...
      { name: 'JSP/AJAX', value: 75 },
      { name: 'Bootstrap 4', value: 75 },
    ],
  },
  {
    ...
    icon: <FaServer />,
    skills: [
      { name: 'Java 11+', value: 95 },
      { name: 'Spring Boot/Spring MVC', value: 95 },
      { name: 'RESTful APIs', value: 90 },
      { name: 'Kafka', value: 90 },
      { name: 'Microservice Arch', value: 90 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'PostgreSQL & Cassendra', value: 90 },
    ],
  },
  {
